...
#  Quest Log
#-------------------------------------------------------------------------------
ModularMenu.add_entry(:QUEST, _INTL("Quest Log"), "menuSave") do |menu|
 pbFadeOutIn {
...
# condition to satisfy
ModularMenu.add_condition(:QUEST) { next hasAnyQuests? }
#-------------------------------------------------------------------------------
#  Encounters
#-------------------------------------------------------------------------------
ModularMenu.add_entry(:ENCOUNTER, _INTL("Encounters"), "menuSave") do |menu|
  pbFadeOutIn {
