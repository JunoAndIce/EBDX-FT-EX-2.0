...
#-------------------------------------------------------------------------------
alias pbMessageDisplay pbMessageDisplay
...
#echoln("Loaded plugin: Easy Text Skip") if Essentials::VERSION != "20.1"