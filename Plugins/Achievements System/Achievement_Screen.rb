class AchievementButton < SpriteWrapper
  ...
  def refresh
    ...
    textpos=[          # Name is written on both unselected and selected buttons
       [@name,14,17,0,Color.new(248,248,248),Color.new(40,40,40)],
       [@name,14,68,0,Color.new(248,248,248),Color.new(40,40,40)],
       [@level,482,17,1,Color.new(248,248,248),Color.new(40,40,40)],
       [@level,482,68,1,Color.new(248,248,248),Color.new(40,40,40)]
    ]
