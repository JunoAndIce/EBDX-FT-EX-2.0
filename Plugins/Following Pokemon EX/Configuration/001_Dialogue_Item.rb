...
EventHandlers.add(:following_pkmn_item, :regular, proc { |_pkmn, _random_val|
  items = [
    :SUPERPOTION,   :FULLRESTORE,    :REVIVE,         :PPUP,          :SUPERREPEL,
    :PPMAX,         :RARECANDY,      :EXPCANDYXL,     :MAXREPEL,      :ESCAPEROPE,
    :HEAVYBALL,     :BIGNUGGET,      :GREATBALL,      :LUREBALL,	  :FULLHEAL,  
    :ULTRABALL,     :THUNDERSTONE,   :MOONSTONE,      :SUNSTONE,      :DUSKSTONE,
	:FIRESTONE,		:WATERSTONE,     :LEAFSTONE, 	  :ULTRAPOTION,   :MAXREVIVE,
	:LOVEBALL, 		:DUSKBALL,       :NETBALL,        :QUICKBALL,     :LEVELBALL,
	:HEALBALL,      :FRIENDBALL,     :MOONBALL,       :RELICSILVER,   :RELICCOPPER,
	:RELICGOLD,     :EXPCANDYL,      :TIMERBALL, 	  :REPEATBALL,    :DREAMBALL,
  ]
